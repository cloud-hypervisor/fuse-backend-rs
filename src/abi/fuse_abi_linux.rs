...
impl From<u32> for Opcode {
    fn from(op: u32) -> Opcode {
        ...
        // (e.g. 0, 7, 19), and transmuting an invalid value into the enum
        // is undefined behavior. Unknown values are mapped to `MaxOpcode`,
        // which callers treat as an unsupported opcode.
        match op {
            1 => Opcode::Lookup,
            2 => Opcode::Forget,
            3 => Opcode::Getattr,
