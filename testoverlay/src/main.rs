...
fn main() -> Result<()> {
	...
	let upperdir = String::from("/home/boyang/hyper/sources/testoverlay/testdir/upper");
	let mut lowerdir = Vec::new();
	lowerdir.push(String::from("/home/boyang/hyper/sources/testoverlay/testdir/lower1"));
	lowerdir.push(String::from("/home/boyang/hyper/sources/testoverlay/testdir/lower2"));
	let workdir = String::from("/home/boyang/hyper/sources/testoverlay/testdir/work");
	let mountpoint = String::from("/home/boyang/hyper/sources/testoverlay/testdir/merged");
